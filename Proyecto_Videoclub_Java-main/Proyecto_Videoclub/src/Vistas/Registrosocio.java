...
public class Registrosocio extends javax.swing.JFrame {
    ...
    Controladores ControladorSocio = new Controladores();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/lado-oscuro-txikito.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 300, 290));
        ...
        jLabel2.setText("¡REGISTRO NUEVOS SOCIOS!");

        jLabel3.setFont(new java.awt.Font("Sitka Text", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("Complete con la información de sus socios.");
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/314974_txt_file_icon.png"))); // NOI18N
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 40, 500, 470));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ControladorSocio.InsertarUsuario(jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), jTextField4.getText());
        limpiarCasillas();
    ...
    private void TXTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TXTActionPerformed
        File file = new File("./src/files/Nuevousuario.txt");
        try {
